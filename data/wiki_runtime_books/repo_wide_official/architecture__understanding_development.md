...
[CRI-O](https://cri-o.io/) container engine. CRI-O runs on every worker and
...
[Red Hat Universal Base Images](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux_atomic_host/7/html-single/getting_started_with_containers/index#using_red_hat_base_container_images_standard_and_minimal) (UBI).
...
Large, public registries include [Docker Hub](https://hub.docker.com/) and
[Quay.io](https://quay.io/). The Quay.io registry is owned and managed by Red
...
registry called [{quay}](https://access.redhat.com/products/red-hat-quay).
...
[Operator](https://www.openshift.com/learn/topics/operators). Operators let you build in
...
* The software catalog, which is available in each OpenShift Container Platform 4.20
...
### Figure 1. Creating and pushing a containerized application

[FIGURE src="/playbooks/wiki-assets/repo_wide_official/architecture__understanding_development/create-push-app.png" alt="Creating and pushing a containerized application" kind="figure" diagram_type="image_figure"]
Creating and pushing a containerized application
[/FIGURE]

_Source: `understanding-development.adoc` · asset `create-push-app.png`_

### Figure 2. OpenShift Container Platform Developer Catalog

[FIGURE src="/playbooks/wiki-assets/repo_wide_official/architecture__understanding_development/developer-catalog.png" alt="OpenShift Container Platform Developer Catalog" kind="figure" diagram_type="image_figure"]
OpenShift Container Platform Developer Catalog
[/FIGURE]

_Source: `understanding-development.adoc` · asset `developer-catalog.png`_
