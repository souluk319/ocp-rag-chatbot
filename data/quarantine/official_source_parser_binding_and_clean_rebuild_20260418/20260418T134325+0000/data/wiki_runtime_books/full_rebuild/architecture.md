...
* For more information on networking, see {product-title} networking.
* For more information on storage, see {product-title} storage.
* For more information on authentication, see {product-title} authentication.
...
As a cluster administrator, you can use the {product-title} installation program to install and deploy a cluster by using one of the following methods:
