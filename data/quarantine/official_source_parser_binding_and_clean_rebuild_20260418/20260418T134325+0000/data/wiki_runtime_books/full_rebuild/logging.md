...
> Because {logging} releases on a different cadence from {product-title}, the {logging} documentation is available as a separate documentation set at [Red{nbsp}Hat OpenShift {logging-uc}](https://docs.redhat.com/en/documentation/red_hat_openshift_logging/).
