...
* {product-title} has a variety of layered offerings to add additional functionality and extend the capabilities of a cluster. For more information, see [{product-title} Operator Life Cycles](https://access.redhat.com/support/policy/updates/openshift_operators)

To navigate the {product-title} data processing unit (DPU) documentation, use the left navigation bar.

For documentation that is not DPU-specific, see the [{product-title} documentation](https://docs.openshift.com/container-platform/latest/welcome/index.html).

> The telco core and telco RAN DU reference design specifications (RDS) are no longer published at this location.

> For the latest version of the telco RDS, see [Telco core and RAN DU reference design specifications](https://docs.openshift.com/container-platform/{product-version}/scalability_and_performance/telco_ref_design_specs/telco-ref-design-specs-overview.html).
...
| --- | --- |
| [What's new in {product-title}](https://www.openshift.com/learn/whats-new) | - |
| [OpenShift blog](https://www.openshift.com/blog?hsLang=en-us) | - |
| [{product-title} Life Cycle Policy](https://access.redhat.com/support/policy/updates/openshift) | - |
| [{product-title} life cycle](https://access.redhat.com/support/policy/updates/openshift#ocp4_phases) | - |
...
| Learn about installing in a restricted network | Optional additional resources a|About disconnected installation mirroring a| If your cluster uses user-provisioned infrastructure, and the cluster does not have full access to the internet, you must mirror the {product-title} installation images. * {aws-first} * {gcp-short} * {vmw-short} * {ibm-cloud-name} * {ibm-z-name} and {ibm-linuxone-name} * {ibm-power-name} * bare metal |
| --- | --- |
...
| --- | --- |
| Understand {product-title} management a|* Machine API * Operators * * etcd | - |
...
| Apply autoscaling to an {product-title} cluster | - |
...
| {product-title} scalability and performance | - |
...
| [About {product-title} monitoring](https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.20/html/about_monitoring/about-ocp-monitoring) a|* Remote health monitoring * {PM-title-c} (Technology Preview) | - |
...
| --- | --- |
| [Getting started with OpenShift for developers (interactive tutorial)](https://developers.redhat.com/products/openshift/getting-started#assembly-field-sections-13455) a|* Understanding {product-title} development * Working with projects * Create deployments | - |
...
For more information, see [{azure-first} Red{nbsp}Hat OpenShift](https://www.redhat.com/en/technologies/cloud-computing/openshift/azure).
...
For more information, see [Red{nbsp}Hat OpenShift on {ibm-cloud-title}](https://www.redhat.com/en/technologies/cloud-computing/openshift/ibm).
...
For more information, see [Red{nbsp}Hat {product-title}](https://www.redhat.com/en/technologies/cloud-computing/openshift/container-platform).

Red{nbsp}Hat {opp}::
Builds on the capabilities of {product-title}.
For more information, see [Red{nbsp}Hat {opp}](https://www.redhat.com/en/technologies/cloud-computing/openshift/platform-plus).
...
launching containers. You download and install OpenShift Kubernetes Engine the same way as {product-title}
...
Product comparison for OpenShift Kubernetes Engine and {product-title}
| Yes |
| --- |
...
vulnerabilities and errors protection as {product-title}. OpenShift Kubernetes Engine includes a
...
OpenShift Kubernetes Engine uses the same security options and default settings as the {product-title}.
...
{product-title} offers are available in OpenShift Kubernetes Engine. OpenShift Kubernetes Engine offers full access to the
...
OpenShift Kubernetes Engine uses the same installation and upgrade automation as {product-title}.
...
{product-title}. OpenShift Kubernetes Engine allows customers to use a Kubernetes Network Policy to
...
Helm, and {product-title} templates. OpenShift Kubernetes Engine users can use both the `oc` and
...
With an OpenShift Kubernetes Engine subscription, you receive access to the {product-title}
...
OpenShift Kubernetes Engine does not include OpenShift Serverless support. Use {product-title}
for this support.
...
{product-title} are not supported in OpenShift Kubernetes Engine.

##### Advanced networking

The standard networking solutions in {product-title} are supported with an
OpenShift Kubernetes Engine subscription. The {product-title} Kubernetes CNI plugin for automation of
...
found in {product-title}. That ingress solution is supported in OpenShift Kubernetes Engine.
...
OpenShift Kubernetes Engine does not include {osc}. Use {product-title} for this support.
...
The following table is a summary of the feature availability in OpenShift Kubernetes Engine and {product-title}. Where applicable, it includes the name of the Operator that enables a feature.

Features in OpenShift Kubernetes Engine and {product-title}
| Feature | OpenShift Kubernetes Engine | {product-title} | Operator name |
| --- | --- | --- | --- |
...
| Telemeter and Insights Connected Experience | Included | Included | N/A s| Feature s| OpenShift Kubernetes Engine s| {product-title} s| Operator name |
...
| RHT and {ibm-name} middleware à la carte purchases (not included in {product-title} or OpenShift Kubernetes Engine) | Included | Included | N/A |
| ISV or Partner Operator and Container Compatibility (not included in {product-title} or OpenShift Kubernetes Engine) | Included | Included | N/A |
...
| OpenShift Service Mesh | Not Included | Included | OpenShift Service Mesh Operator s| Feature s| OpenShift Kubernetes Engine s| {product-title} s| Operator name |
...
| {rh-storage} | Not Included - Requires separate subscription | Not Included - Requires separate subscription | {rh-storage} s| Feature s| OpenShift Kubernetes Engine s| {product-title} s| Operator name |
...
OpenShift Kubernetes Engine is a subscription offering that provides {product-title} with a limited set
of supported features at a lower list price. OpenShift Kubernetes Engine and {product-title} are the
same product and, therefore, all software and features are delivered in both.
There is only one download, {product-title}. OpenShift Kubernetes Engine uses the {product-title}
...
** To create a [Jira issue](https://issues.redhat.com/secure/CreateIssueDetails!init.jspa?pid=12332330&summary=Documentation_issue&issuetype=1&components=12367614&priority=10200&versions=12436721) for {product-title}
