...
Remote health monitoring issues:
{product-title} collects telemetry and configuration data about your cluster and reports it to Red Hat by using the Telemeter Client and the {insights-operator}. Red Hat uses this data to understand and resolve issues in a _connected cluster_. Similar to connected clusters, you can Use remote health monitoring in a restricted network. {product-title} collects data and monitors health using the following:
