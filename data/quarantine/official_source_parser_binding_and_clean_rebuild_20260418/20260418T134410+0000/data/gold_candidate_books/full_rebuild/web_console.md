...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/cluster-settings-console.png" alt="Image of the Configuration page showing the correct Console configuration resource to select" kind="figure" diagram_type="image_figure"]
Image of the Configuration page showing the correct Console configuration resource to select
[/FIGURE]

_Source: `access-cluster-configuration-console.adoc` · asset `cluster-settings-console.png`_
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/customizing-user-perspective.png" alt="customizing-user-perspective" kind="figure" diagram_type="image_figure"]
customizing-user-perspective
[/FIGURE]

_Source: `odc-customizing-a-perspective-using-form-view.adoc` · asset `customizing-user-perspective.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/odc_customizing_developer_catalog.png" alt="odc customizing developer catalog" kind="figure" diagram_type="image_figure"]
odc customizing developer catalog
[/FIGURE]

_Source: `odc_customizing-a-developer-catalog-or-its-sub-catalogs-using-the-form-view.adoc` · asset `odc_customizing_developer_catalog.png`_
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/quick-start-conclusion.png" alt="quick start conclusion in the web console" kind="figure" diagram_type="image_figure"]
quick start conclusion in the web console
[/FIGURE]

_Source: `understanding-quick-start-elements.adoc` · asset `quick-start-conclusion.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/quick-start-description.png" alt="quick start description in the web console" kind="figure" diagram_type="image_figure"]
quick start description in the web console
[/FIGURE]

_Source: `understanding-quick-start-elements.adoc` · asset `quick-start-description.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/quick-start-display-name.png" alt="quick start display name in the web console" kind="figure" diagram_type="image_figure"]
quick start display name in the web console
[/FIGURE]

_Source: `understanding-quick-start-elements.adoc` · asset `quick-start-display-name.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/quick-start-duration.png" alt="quick start durationMinutes element in the web console" kind="figure" diagram_type="image_figure"]
quick start durationMinutes element in the web console
[/FIGURE]

_Source: `understanding-quick-start-elements.adoc` · asset `quick-start-duration.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/quick-start-icon.png" alt="quick start icon element in the web console" kind="figure" diagram_type="image_figure"]
quick start icon element in the web console
[/FIGURE]

_Source: `understanding-quick-start-elements.adoc` · asset `quick-start-icon.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/web_console/quick-start-introduction.png" alt="quick start introduction element in the web console" kind="figure" diagram_type="image_figure"]
quick start introduction element in the web console
[/FIGURE]

_Source: `understanding-quick-start-elements.adoc` · asset `quick-start-introduction.png`_
