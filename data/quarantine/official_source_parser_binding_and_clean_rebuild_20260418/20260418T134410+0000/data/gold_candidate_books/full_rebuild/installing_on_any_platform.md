...
### Figure 1. {product-title} installation targets and dependencies

[FIGURE src="/playbooks/wiki-assets/full_rebuild/installing_on_any_platform/targets-and-dependencies.png" alt="{product-title} installation targets and dependencies" kind="figure" diagram_type="image_figure"]
{product-title} installation targets and dependencies
[/FIGURE]

_Source: `installation-overview.adoc` · asset `targets-and-dependencies.png`_

### Figure 2. Creating bootstrap

[FIGURE src="/playbooks/wiki-assets/full_rebuild/installing_on_any_platform/create-nodes.png" alt="Creating bootstrap" kind="figure" diagram_type="image_figure"]
Creating bootstrap
[/FIGURE]

_Source: `installation-process.adoc` · asset `create-nodes.png`_

### Figure 3. Creating bootstrap

[FIGURE src="/playbooks/wiki-assets/full_rebuild/installing_on_any_platform/150_OpenShift_VMware_on_AWS_1021_installer_FCOS.png" alt="Creating bootstrap" kind="figure" diagram_type="image_figure"]
Creating bootstrap
[/FIGURE]

_Source: `installation-process.adoc` · asset `150_OpenShift_VMware_on_AWS_1021_installer_FCOS.png`_
