...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/202_OpenShift_Ingress_0222_node_port.png" alt="OpenShift Container Platform Ingress NodePort endpoint publishing strategy" kind="figure" diagram_type="image_figure"]
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/external-load-balancer-default.png" alt="An image that shows an example network workflow of an Ingress Controller operating in an OpenShift Container Platform environment." kind="diagram" diagram_type="semantic_diagram"]
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/external-load-balancer-openshift-api.png" alt="An image that shows an example network workflow of an OpenShift API operating in an OpenShift Container Platform environment." kind="diagram" diagram_type="semantic_diagram"]
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/external-load-balancer-machine-config-api.png" alt="An image that shows an example network workflow of an OpenShift MachineConfig API operating in an OpenShift Container Platform environment." kind="diagram" diagram_type="semantic_diagram"]
