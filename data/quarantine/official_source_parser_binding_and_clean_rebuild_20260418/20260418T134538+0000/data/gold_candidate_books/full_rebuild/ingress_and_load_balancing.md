...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/nw-sharding-route-labels.png" alt="A diagram showing multiple Ingress Controllers with different route selectors serving any route containing a label that matches a given route selector regardless of the namespace a route belongs to" kind="diagram" diagram_type="semantic_diagram"]
...
_Source: `nw-ingress-sharding-namespace-labels.adoc` · asset `nw-sharding-namespace-labels.png`_
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/202_OpenShift_Ingress_0222_node_port.png" alt="{product-title} Ingress NodePort endpoint publishing strategy" kind="figure" diagram_type="image_figure"]
{product-title} Ingress NodePort endpoint publishing strategy
[/FIGURE]

_Source: `nw-ingress-controller-endpoint-publishing-strategies.adoc` · asset `202_OpenShift_Ingress_0222_node_port.png`_
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/external-load-balancer-default.png" alt="An image that shows an example network workflow of an Ingress Controller operating in an {product-title} environment." kind="diagram" diagram_type="semantic_diagram"]
An image that shows an example network workflow of an Ingress Controller operating in an {product-title} environment.
[/FIGURE]

_Source: `nw-osp-services-external-load-balancer.adoc` · asset `external-load-balancer-default.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/external-load-balancer-openshift-api.png" alt="An image that shows an example network workflow of an OpenShift API operating in an {product-title} environment." kind="diagram" diagram_type="semantic_diagram"]
An image that shows an example network workflow of an OpenShift API operating in an {product-title} environment.
[/FIGURE]

_Source: `nw-osp-services-external-load-balancer.adoc` · asset `external-load-balancer-openshift-api.png`_


[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/external-load-balancer-machine-config-api.png" alt="An image that shows an example network workflow of an OpenShift MachineConfig API operating in an {product-title} environment." kind="diagram" diagram_type="semantic_diagram"]
An image that shows an example network workflow of an OpenShift MachineConfig API operating in an {product-title} environment.
[/FIGURE]

_Source: `nw-osp-services-external-load-balancer.adoc` · asset `external-load-balancer-machine-config-api.png`_
...
[FIGURE src="/playbooks/wiki-assets/full_rebuild/ingress_and_load_balancing/357_OpenShift_MetalLB_VRF_0823.png" alt="Network overview of managing symmetric routing by using VRFs with MetalLB" kind="figure" diagram_type="image_figure"]
Network overview of managing symmetric routing by using VRFs with MetalLB
[/FIGURE]

_Source: `overview-of-managing-symmetric-routing-using-vrf-based-networks-with-metallb.adoc` · asset `357_OpenShift_MetalLB_VRF_0823.png`_
