...
> Because {logging} releases on a different cadence from OpenShift Container Platform, the {logging} documentation is available as a separate documentation set at [Red Hat OpenShift {logging-uc}](https://docs.redhat.com/en/documentation/red_hat_openshift_logging/).
