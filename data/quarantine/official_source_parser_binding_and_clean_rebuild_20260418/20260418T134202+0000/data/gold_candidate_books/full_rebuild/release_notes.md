...
### layered and dependent component support and compatibility
...
##### NetworkPolicy support for the Operator
...
##### Support for hostname labelling for persistent volumes created by using the Operator
...
##### Default namespace for the Operator
...
##### support for tailored network policies in Operators
...
##### Installing a cluster on with multiple network interface controllers (Generally Available)
...
##### Installing a cluster on into a shared VPC specifying a DNS private zone in a third project
...
##### Installing a cluster on with virtual network encryption
...
##### Firewall requirements when installing a cluster that uses Cloud Paks
...
##### Installing a cluster on using Intel TDX Confidential VMs
...
##### Dedicated disk for etcd on (Technology Preview)
...
##### Required administrator acknowledgment when updating from 4.19 to 4.20
...
##### Support for Foundation 9 and VMware Cloud Foundation 9
...
##### Setting the kernel type parameter is now supported on nodes
...
##### Additional Capacity Reservation configuration options
...
##### Preconfigured user-defined network endpoints only for use with (Technology Preview)
...
##### RedHat Operator catalogs moved from OperatorHub to the software catalog in the console
...
#### 7 and VMware Cloud Foundation 4 end of general support
...
##### RedHat Marketplace is deprecated
