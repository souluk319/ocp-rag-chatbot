...
from ocp_doc_to_book.normalization.pdf import PdfOutlineEntry, _normalize_page_text, extract_pdf_pages
from ocp_doc_to_book.normalization.service import (
...
"""
    ...
    def test_normalize_service_builds_canonical_book_from_captured_pdf(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "ocp_doc_to_book.normalization.service.extract_pdf_pages",
                return_value=[
    ...
    def test_normalize_service_prefers_pdf_outline_for_section_structure(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                ...
                "ocp_doc_to_book.normalization.service.extract_pdf_outline",
                return_value=[
