...
class TestAppRuntimeUi(unittest.TestCase):
    ...
    def test_static_ui_guards_enter_during_ime_composition(self) -> None:
        ...
        self.assertIn('id="data-situation-room-active-queue-list"', data_situation_room_html)
        self.assertIn('id="data-situation-room-known-books-table"', data_situation_room_html)
        self.assertIn('id="data-situation-room-drift-list"', data_situation_room_html)
        self.assertIn('id="data-situation-room-high-value-list"', data_situation_room_html)
        self.assertIn('id="data-situation-room-eval-note"', data_situation_room_html)
        self.assertIn('id="data-situation-room-runtime-note"', data_situation_room_html)
        self.assertIn('id="data-situation-room-gold-count-pill">-<', data_situation_room_html)
        self.assertIn('id="data-situation-room-queue-count-pill">-<', data_situation_room_html)
        self.assertIn('id="data-situation-room-chunk-count-pill">-<', data_situation_room_html)
        ...
        self.assertIn("known_books", data_situation_room)
        self.assertIn("active_queue", data_situation_room)
        self.assertIn("source_of_truth_drift", data_situation_room)
        self.assertIn("function corpusRowCard", data_situation_room)
        self.assertIn("function manualbookRowCard", data_situation_room)
        self.assertIn('linkKind: "source"', data_situation_room)
        self.assertIn('linkKind: "viewer"', data_situation_room)
        self.assertIn("function renderErrorState", data_situation_room)
        self.assertIn("renderOpsNotes(payload)", data_situation_room)
