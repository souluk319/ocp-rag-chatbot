...
class TestAppRuntimeUi(unittest.TestCase):
    ...
    def test_playbook_ui_is_the_main_surface(self) -> None:
        ...
        workspace_viewer_panel_tsx = self._read("presentation-ui/src/pages/workspace/WorkspaceViewerPanel.tsx")
        ...
        self.assertNotIn("Full Source Catalog", library_tsx)
        self.assertNotIn("Gold Source Books", library_tsx)
        self.assertNotIn("Derived Playbooks", library_tsx)
        self.assertNotIn("openMetricPopover('manual')", library_tsx)
        self.assertNotIn("openMetricPopover('derived')", library_tsx)
        ...
        self.assertIn("uploadAccept={CUSTOMER_PACK_UPLOAD_ACCEPT}", workspace_tsx)
        self.assertIn("accept={uploadAccept}", workspace_viewer_panel_tsx)
        ...
        self.assertIn("playbook-grade-badge", workspace_tsx)
        self.assertIn("playbook-grade-badge", library_tsx)
        self.assertIn("normalizePlaybookGrade(file.grade)", workspace_tsx)
        ...
        self.assertNotIn("raw runtime payload", trace_panel_tsx)
        self.assertNotIn("Copy turn JSON", trace_panel_tsx)
        self.assertNotIn("JSON.stringify(result.retrieval_trace, null, 2)", trace_panel_tsx)
        self.assertNotIn("JSON.stringify(result.pipeline_trace, null, 2)", trace_panel_tsx)
        self.assertIn("질문 해석", explain_helper_ts)
        self.assertIn("assistant-truth-chip", workspace_css)
        self.assertIn("playbook-grade-badge--gold", workspace_css)
