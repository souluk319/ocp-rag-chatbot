...
- Stage 13 adds source-profile abstraction so validation can stay on `main` while future operator releases can switch to a target-minor branch through configuration and recorded git lineage

## Next milestones

1. Activate a target-minor source profile once the operator-facing release minor is approved
