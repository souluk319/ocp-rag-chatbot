    ...
    for entry in active_entries:
        ...
        _upsert_registry_entry(
            ...
            incoming={
                ...
                "docs_viewer_path": _docs_viewer_path(settings, slug),
                "source_url": str(entry.get("source_candidate_path") or source_entry.get("source_url") or ""),
                "source_lane": str(source_entry.get("source_lane") or "approved_wiki_runtime"),
                "source_type": str(source_entry.get("source_type") or "reader_grade_md"),
                "approval_state": str(source_entry.get("approval_state") or source_entry.get("approval_status") or "approved"),
                "publication_state": str(source_entry.get("publication_state") or "active"),
                ...
                "updated_at": str(active_manifest_payload.get("generated_at_utc") or ""),
                "active_runtime": True,
