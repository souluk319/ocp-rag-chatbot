...
window.createAppShellState = function createAppShellState(deps) {
  ...
  const refs = {
    ...
    sourceEmptyEl: document.getElementById("source-empty"),
    sourceEmptyTitleEl: document.getElementById("source-empty-title"),
    sourceEmptyDetailEl: document.getElementById("source-empty-detail"),
