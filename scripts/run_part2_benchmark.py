...
from ocp_rag_part2.eval import summarize_case_results
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the Part 2 retrieval benchmark")
    parser.add_argument(
        "--cases",
        type=Path,
...
def main() -> int:
    ...
    output_path = settings.part2_dir / "benchmark_report.json"
